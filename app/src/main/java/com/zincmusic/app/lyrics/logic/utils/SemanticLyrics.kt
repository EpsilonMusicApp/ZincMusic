package com.zincmusic.app.lyrics.logic.utils
...
import com.zincmusic.app.lyrics.logic.utils.SemanticLyrics.LyricLine
import com.zincmusic.app.lyrics.logic.utils.SemanticLyrics.SyncedLyrics
import com.zincmusic.app.lyrics.logic.utils.SemanticLyrics.UnsyncedLyrics
import com.zincmusic.app.lyrics.logic.utils.SemanticLyrics.Word
...
inline fun <T> List<T>.forEachSupport(skipFirst: Int = 0, action: (T) -> Unit) {
    for (i in skipFirst until size) {
        action(get(i))
    }
}
                            ...
                            when (parser.name) {
                                ...
                                "audio" -> {
                                    ...
                                    if (when (role) {
                                            ...
                                            // ext- are extended metadata extensions
