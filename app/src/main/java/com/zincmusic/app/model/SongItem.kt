package com.zincmusic.app.model
...
fun SongItem.toPlaylistSongEntity(playlistId: Long, position: Int = 0): com.zincmusic.app.data.db.PlaylistSongEntity {
    return com.zincmusic.app.data.db.PlaylistSongEntity(
...
fun com.zincmusic.app.data.db.PlaylistSongEntity.toSongItem(): SongItem {
