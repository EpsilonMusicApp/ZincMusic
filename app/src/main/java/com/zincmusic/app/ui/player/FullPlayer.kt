package com.zincmusic.app.ui.player
...
import com.zincmusic.app.data.lyrics.LyricLine
...
fun FullPlayerScreen(
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted) {
            ...
            com.zincmusic.app.ui.SnackbarController.showMessage("Microphone permission required for haptics")
        }
    }
                ...
                PillChip(
                    ...
                    onClick = {
                        val shareIntent = Intent().apply {
                            ...
                            putExtra(Intent.EXTRA_TEXT, "Listening on Zinc Music Check out : https://music.youtube.com/watch?v=${uiState.currentSong?.videoId}")
                            type = "text/plain"
                        }
                ...
                PillChip(
                    ...
                    onClick = {
                        ...
                        if (currentSong != null && !realDownloaded && !isDownloading) {
                            com.zincmusic.app.util.SongDownloader.downloadSong(context, currentSong)
                        }
                    },
                    contentColor = contentColor,
                    accentColor = dynamicAccentColor,
