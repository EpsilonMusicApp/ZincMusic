package com.zincmusic.app.data.lyrics

import android.util.Log
import com.zincmusic.app.lyrics.logic.utils.LrcUtils
import com.zincmusic.app.lyrics.logic.utils.SemanticLyrics

/**
 * Parses lyrics content into a list of [LyricLine]s.
 * Delegate parsing to the high-fidelity LrcUtils parser.
 */
object LrcParser {
    ...
    fun parse(lrcContent: String?): List<LyricLine> {
        ...
        // Use robust parser options: trim=true, multiLine=true
        ...
        val semanticLyrics = try {
            ...
            Log.e(TAG, "Error parsing lyrics via LRC parser", e)
            null
        } ?: return emptyList()
