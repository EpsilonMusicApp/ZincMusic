package com.zincmusic.app.data.lyrics.engine

import android.content.Context
import android.os.Handler
import android.os.Looper
import android.util.Log
import com.zincmusic.app.data.lyrics.ConfidenceScorer
import com.zincmusic.app.data.lyrics.LrcLibApi
import com.zincmusic.app.data.lyrics.LyricsNormalizer
import com.zincmusic.app.data.lyrics.LyricsResult
import com.zincmusic.app.data.lyrics.MetadataRepair
import com.zincmusic.app.data.lyrics.TrackMetadata
import com.zincmusic.app.data.lyrics.providers.EmbeddedLyricsProvider
import com.zincmusic.app.data.lyrics.providers.LrcLibProvider
import com.zincmusic.app.data.lyrics.providers.LyricsProvider
...
class LyricsFetchManager private constructor(context: Context) {
    ...
    private fun createProviders(client: OkHttpClient): List<LyricsProvider> {
        ...
        // ═══════════════════════════════════════════
        providers.add(com.zincmusic.app.data.lyrics.providers.YouTubeMusicLyricsProvider())
        ...
        val syncLrcApi = Retrofit.Builder()
            ...
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(com.zincmusic.app.data.lyrics.SyncLrcApi::class.java)
        providers.add(com.zincmusic.app.data.lyrics.providers.SyncLrcProvider(syncLrcApi))
        ...
        val paxsenixApi = Retrofit.Builder()
            ...
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(com.zincmusic.app.data.lyrics.PaxsenixApi::class.java)

        providers.add(com.zincmusic.app.data.lyrics.providers.paxsenix.PaxsenixAppleMusicProvider(paxsenixApi))
        providers.add(com.zincmusic.app.data.lyrics.providers.paxsenix.PaxsenixSpotifyProvider(paxsenixApi))
        providers.add(com.zincmusic.app.data.lyrics.providers.paxsenix.PaxsenixMusixmatchProvider(paxsenixApi))
        providers.add(com.zincmusic.app.data.lyrics.providers.paxsenix.PaxsenixYoutubeProvider(paxsenixApi))
