...
import com.zincmusic.app.service.AudioPlaybackService
import com.zincmusic.app.ui.EffectsScreenEntryPoint
import com.zincmusic.app.ui.PlayerBottomSheetCompose
import com.zincmusic.app.ui.SettingsScreenContent
import com.zincmusic.app.ui.TagEditorScreenEntryPoint
import com.zincmusic.app.ui.explore.ExploreScreen
import com.zincmusic.app.ui.explore.GoogleSignInScreen
import com.zincmusic.app.ui.library.LibraryScreen
import com.zincmusic.app.ui.theme.ZincMusicTheme
import com.zincmusic.app.ui.theme.observeKey
import com.zincmusic.app.ui.onboarding.OnboardingScreen
import android.content.Context
import com.zincmusic.app.update.GitHubReleaseClient
import com.zincmusic.app.update.UpdateManager
import com.zincmusic.app.update.VersionUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            ZincMusicTheme(darkTheme = isDarkTheme, dynamicAlbumColor = dynamicAlbumColor) {
                        ...
                        Box(
                            ...
                            NavHost(
                                ...
                                composable("google_signin") {
                                    val accountViewModel: com.zincmusic.app.viewmodel.AccountViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
                                    GoogleSignInScreen(
    ...
    fun showArtistPage(artistId: String?, artistName: String?) {
        ...
        if (!artistId.isNullOrBlank()) {
            ...
            exploreViewModel.setSearchFilter(com.zincmusic.app.data.innertube.SearchFilter.ARTISTS)
    ...
    private fun checkForUpdateOnLaunch() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                val client = GitHubReleaseClient("EpsilonMusicApp", "ZincMusic")
    ...
    fun showSnackbar(message: String, duration: Int) {
        com.zincmusic.app.ui.SnackbarController.showMessage(message)
    }
