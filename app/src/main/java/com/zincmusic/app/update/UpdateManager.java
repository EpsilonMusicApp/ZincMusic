...
public class UpdateManager {
    ...
    private static final String GITHUB_OWNER = "EpsilonMusicApp";
    private static final String GITHUB_REPO = "ZincMusic";
    ...
    private void startDownload(View rootView, String apkUrl) {
        try {
            ...
            request.setTitle("Zinc Music Update");
            request.setDescription("Downloading latest version...");
            request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);

            String filename = "Zinc Music-update.apk";
    ...
    private void showSnackbarAnchored(View rootView, String msg, int duration) {
        runOnUi(() -> com.zincmusic.app.ui.SnackbarController.INSTANCE.showMessage(msg));
    }
